// src/substance/dto/update-substance.dto.ts
import { z } from "zod";
...
export const updateSubstanceSchema = z.object({
  nist: z
    .number()
  ...
  tR: z.number().positive("Retention time must be positive").optional(),
  ...
  molecularWeight: z.number().positive("Molecular weight must be positive").optional(),

  ionBase: ionSchema.optional(),
